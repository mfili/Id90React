...
let PeriodToolbar = props => {
  const { numSelected, classes, onEditClick, listSocialWorkPlan, onDeleteClick, onAddClick, onPdf, obrasSociales, handleExportClose, handleExportClick, anchorEl } = props
  var anchor = null
  var multiDataSet = []
  if(obrasSociales.obrasSociales.length!=0){
    ...
    for (var i = 0; i < obrasSociales.obrasSociales.length; i++) {
      multiDataSet[0].data.push([obrasSociales.obrasSociales[i].codigoObraSocial,
        obrasSociales.obrasSociales[i].descripcion])
    }
  }
      ...
      <Grid container spacing={0}>
        <Grid item xs={6}>
          ...
          <ExcelFile  element={(
            ...
            <ExcelSheet dataSet={multiDataSet} name="ObrasSociales" />
          </ExcelFile>
      ...
      <Grid container spacing={0}>
        ...
        <Grid item xs={3}>
          <Tooltip title="Planes">
            <IconButton aria-label="Planes" onClick={listSocialWorkPlan}>
              <List />
            </IconButton>
          </Tooltip>
        </Grid>
      ...
      <div className={classes.title}>
        {numSelected > 0 ? (
          <Typography type="subheading">{numSelected} selected</Typography>
            ...
            <Typography type="title">Obras Sociales</Typography>
          )}
      </div>
